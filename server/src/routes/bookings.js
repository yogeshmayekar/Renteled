...
import {bookingHotel, bookingsByUserId, bookingsForHotels, toGetAllUser, basedOnBookingId, cancelHotel} from '../controllers/booking.js';
...
//to cancel booking
router.put("/cancel/:id", verifyUser, cancelHotel);
